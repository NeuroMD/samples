...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EcgDeviceModel model = createAndInitModel();
        mMainPresenter = new MainActivityPresenter(this, model);
        mEcgPresenter = new EcgParamsPresenter(this, model);
        mEcgDrawerPresenter = new EcgDrawerPresenter(model);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                mEcgDrawerPresenter.setScrollVelocity(mVelocityTracker.getXVelocity(pointerId));
                break;
    ...
    private EcgDeviceModel createAndInitModel(){
        EcgDeviceModel model = new EcgDeviceModel(getApplicationContext());
    ...
    private void initDrawer(){
        IDrawerEngine drawerEngine = new EcgDrawingEngine(mEcgDrawerPresenter);
    ...
    private void initScaleControls(){
        ...
        verticalScaleIncrementButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mEcgDrawerPresenter.incrementVerticalScale();
            }
        });
        mEcgDrawerPresenter.verticalScaleIncrementButtonEnabledChanged.subscribe(new INotificationCallback<Boolean>() {
            @Override
            public void onNotify(Object sender, Boolean isEnabled) {
        ...
        verticalScaleDecrementButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mEcgDrawerPresenter.decrementVerticalScale();
            }
        });
        mEcgDrawerPresenter.verticalScaleDecrementButtonEnabledChanged.subscribe(new INotificationCallback<Boolean>() {
            @Override
            public void onNotify(Object sender, Boolean isEnabled) {
        ...
        verticalTextView.setText(mEcgDrawerPresenter.getVerticalScale().getLabel());
        mEcgDrawerPresenter.verticalScaleChanged.subscribe(new INotificationCallback<ScaleValue>() {
            @Override
        ...
        horizontalScaleIncrementButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mEcgDrawerPresenter.incrementHorizontalScale();
            }
        });
        mEcgDrawerPresenter.horizontalScaleIncrementButtonEnabledChanged.subscribe(new INotificationCallback<Boolean>() {
            @Override
            public void onNotify(Object sender, Boolean isEnabled) {
        ...
        horizontalScaleDecrementButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mEcgDrawerPresenter.decrementHorizontalScale();
            }
        });
        mEcgDrawerPresenter.horizontalScaleDecrementButtonEnabledChanged.subscribe(new INotificationCallback<Boolean>() {
            @Override
            public void onNotify(Object sender, Boolean isEnabled) {
        ...
        horizontalTextView.setText(mEcgDrawerPresenter.getHorizontalScale().getLabel());
        mEcgDrawerPresenter.horizontalScaleChanged.subscribe(new INotificationCallback<ScaleValue>() {
            @Override
            public void onNotify(Object sender, ScaleValue scaleValue) {
