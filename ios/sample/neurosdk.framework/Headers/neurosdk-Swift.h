...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="neurosdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8neurosdk13NTBaseChannel")
...
SWIFT_CLASS("_TtC8neurosdk16NTBatteryChannel")
...
SWIFT_CLASS("_TtC8neurosdk15NTDeviceScanner")
@interface NTDeviceScanner : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC8neurosdk20NTEegArtifactChannel")
@interface NTEegArtifactChannel : NTBaseChannel
@end


SWIFT_CLASS("_TtC8neurosdk12NTEegChannel")
@interface NTEegChannel : NTBaseChannel
@end


SWIFT_CLASS("_TtC8neurosdk17NTEegIndexChannel")
...
SWIFT_CLASS("_TtC8neurosdk23NTElectrodeStateChannel")
